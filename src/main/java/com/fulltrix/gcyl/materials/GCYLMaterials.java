...
public class GCYLMaterials {
    ...
    private static void register() {
        ...
        EglinSteelBase = new Material.Builder(++id, gcylId("eglin_steel_base"))
                ...
                .color(0x8B4513)
                .iconSet(SAND)
                .components(Iron, 4, Kanthal, 1, Invar, 5).build();
        ...
        LeadZirconateTitanate = new Material.Builder(++id, gcylId("lead_zirconate_titanate"))
                ...
                .iconSet(OPAL)
                .flags(GENERATE_PLATE)
                .components(Lead, 1, Zirconium, 1, Titanium, 1, Oxygen, 3).build();
        ...
        LithiumTitanate = new Material.Builder(++id, gcylId("lithium_titanate"))
                ...
                .components(Lithium, 2, Titanium, 1, Oxygen, 3).build();
        ...
        CarbonNanotubes = new Material.Builder(++id, gcylId("carbon_nanotubes"))
                ...
                .components(Carbon, 1).build();

        SodiumSeaborgate = new Material.Builder(++id, gcylId("sodium_seaborgate"))
                .ingot()
                .color(0x55bbd4)
                .iconSet(SHINY)
                .components(Sodium, 2, Seaborgium, 1, Oxygen, 4).build();

        TBCCODust = new Material.Builder(++id, gcylId("TBCCODust"))
                .dust()
                .color(0x669900)
                .iconSet(SHINY)
                .components(Thallium, 1, Barium, 2, Calcium, 2, Copper, 3, Oxygen, 10).build();
        ...
        SodiumFluoride = new Material.Builder(++id, gcylId("sodium_fluoride"))
                ...
                .iconSet(DULL)
                .components(Sodium, 1, Fluorine, 1).build();
        ...
        Prasiolite = new Material.Builder(++id, gcylId("prasiolite"))
                ...
                .iconSet(QUARTZ)
                .flags(GENERATE_LENS)
                .components(Silicon, 5, Oxygen, 10, Iron, 1).build();

        BismuthTellurite = new Material.Builder(++id, gcylId("bismuth_tellurite"))
                .dust(2)
                .color(0x006B38)
                .iconSet(SAND)
                .components(Bismuth, 2, Tellurium, 3).build();
        ...
        CubicZirconia = new Material.Builder(++id, gcylId("cubic_zirconia"))
                ...
                .components(Zirconium, 1, Oxygen, 2).build();
        ...
        MagnetoResonatic = new Material.Builder(++id, gcylId("magneto_resonatic"))
                ...
                .components(Prasiolite, 3, BismuthTellurite, 6, CubicZirconia, 1, SteelMagnetic, 1).build();
        ...
        Jasper = new Material.Builder(++id, gcylId("jasper"))
                ...
                .iconSet(EMERALD)
                .ore()
                .flags(NO_SMELTING, HIGH_SIFTER_OUTPUT).build();
        ...
        Quantum = new Material.Builder(++id, gcylId("quantum"))
                ...
                .blast(b->b.temp(11400, BlastProperty.GasTier.HIGHEST).blastStats(VA[UHV], 1200)).build();
        ...
        Polyimide = new Material.Builder(++id, gcylId("polyimide"))
                ...
                .components(Carbon, 22, Hydrogen, 12, Nitrogen, 2, Oxygen, 6).build();
        ...
        BariumTitanate = new Material.Builder(++id, gcylId("barium_titanate"))
                ...
                .components(Barium, 1, Titanium, 1, Oxygen, 3).build();
        ...
        PEDOT = new Material.Builder(++id, gcylId("pedot"))
                ...
                .components(Carbon, 6, Hydrogen, 6, Oxygen, 2, Sulfur, 1).build();
        ...
        BismuthRuthenate = new Material.Builder(++id, gcylId("bismuth_ruthenate"))
                ...
                .components(Bismuth, 2, Ruthenium, 2, Oxygen, 7).build();
        ...
        BismuthIridiate = new Material.Builder(++id, gcylId("bismuth_iridiate"))
                ...
                .iconSet(DULL)
                .flags(GENERATE_PLATE, DISABLE_DECOMPOSITION)
                .components(Bismuth, 2, Iridium, 2, Oxygen, 7).build();
        ...
        RutheniumDioxide = new Material.Builder(++id, gcylId("ruthenium_dioxide"))
                ...
                .iconSet(DULL)
                .flags(GENERATE_PLATE, DISABLE_DECOMPOSITION)
                .components(Ruthenium, 1, Oxygen, 2).build();
        ...
        Polystyrene = new Material.Builder(++id, gcylId("polystyrene"))
                ...
                .iconSet(DULL)
                .flags(GENERATE_FOIL, DISABLE_DECOMPOSITION)
                .components(Carbon, 8, Hydrogen, 8).build();
        ...
        YttriumOxide = new Material.Builder(++id, gcylId("yttrium_oxide"))
                ...
                .flags(DISABLE_DECOMPOSITION).build();
        ...
        BerylliumFluoride = new Material.Builder(++id, gcylId("beryllium_fluoride"))
                ...
                .color(0x757575)
                .iconSet(SHINY)
                .components(Beryllium, 1, Fluorine, 2).build();
        ...
        Polyurethane = new Material.Builder(++id, gcylId("polyurethane"))
                ...
                .color(0xeffcef)
                .iconSet(DULL)
                .flags(DISABLE_DECOMPOSITION, GENERATE_ROD, NO_SMASHING)
        ...
        if (GCYLCore.isModLoaded("materialreplication")) {
            ...
            EglinSteel.addFlags(DISABLE_REPLICATION);
            Pikyonium.addFlags(DISABLE_REPLICATION);
            LithiumNiobate.addFlags(DISABLE_REPLICATION);
            Polyetheretherketone.addFlags(DISABLE_REPLICATION);
            LeadZirconateTitanate.addFlags(DISABLE_REPLICATION);
            LithiumTitanate.addFlags(DISABLE_REPLICATION);
            CarbonNanotubes.addFlags(DISABLE_REPLICATION);
            SodiumSeaborgate.addFlags(DISABLE_REPLICATION);
            TBCCODust.addFlags(DISABLE_REPLICATION);
            SodiumFluoride.addFlags(DISABLE_REPLICATION);
            TungstenTitaniumCarbide.addFlags(DISABLE_REPLICATION);
            Prasiolite.addFlags(DISABLE_REPLICATION);
            BismuthTellurite.addFlags(DISABLE_REPLICATION);
            CubicZirconia.addFlags(DISABLE_REPLICATION);
            MagnetoResonatic.addFlags(DISABLE_REPLICATION);
            HDCS.addFlags(DISABLE_REPLICATION);
            Jasper.addFlags(DISABLE_REPLICATION);
            Quantum.addFlags(DISABLE_REPLICATION);
            Adamantium.addFlags(DISABLE_REPLICATION);
            Cinobite.addFlags(DISABLE_REPLICATION);
            Polyimide.addFlags(DISABLE_REPLICATION);
            GermaniumTungstenNitride.addFlags(DISABLE_REPLICATION);
            BariumTitanate.addFlags(DISABLE_REPLICATION);
            PEDOT.addFlags(DISABLE_REPLICATION);
            BismuthRuthenate.addFlags(DISABLE_REPLICATION);
            BismuthIridiate.addFlags(DISABLE_REPLICATION);
            RutheniumDioxide.addFlags(DISABLE_REPLICATION);
            YttriumOxide.addFlags(DISABLE_REPLICATION);
            HydrogenPeroxide.addFlags(DISABLE_REPLICATION);
            BerylliumFluoride.addFlags(DISABLE_REPLICATION);
            PotassiumManganate.addFlags(DISABLE_REPLICATION);
            ManganeseSulfate.addFlags(DISABLE_REPLICATION);
            PotassiumSulfate.addFlags(DISABLE_REPLICATION);
            AmmoniumCyanate.addFlags(DISABLE_REPLICATION);
            LithiumFluoride.addFlags(DISABLE_REPLICATION);
            AluminaSolution.addFlags(DISABLE_REPLICATION);
            PreciousMetal.addFlags(DISABLE_REPLICATION);
            GoldAlloy.addFlags(DISABLE_REPLICATION);
            GoldLeach.addFlags(DISABLE_REPLICATION);
            CopperLeach.addFlags(DISABLE_REPLICATION);
            ChloroauricAcid.addFlags(DISABLE_REPLICATION);
            PotassiumMetabisulfite.addFlags(DISABLE_REPLICATION);
            OrthoXylene.addFlags(DISABLE_REPLICATION);
            Durene.addFlags(DISABLE_REPLICATION);
            PyromelliticDianhydride.addFlags(DISABLE_REPLICATION);
            Oxydianiline.addFlags(DISABLE_REPLICATION);
            PolyamicAcid.addFlags(DISABLE_REPLICATION);
            Hexafluoropropylene.addFlags(DISABLE_REPLICATION);
            FluorinatedEthylenePropylene.addFlags(DISABLE_REPLICATION);
            Polystyrene.addFlags(DISABLE_REPLICATION);
            NaquadriaticTaranium.addFlags(DISABLE_REPLICATION);
            BlackTitanium.addFlags(DISABLE_REPLICATION);
            FullerenePolymerMatrix.addFlags(DISABLE_REPLICATION);
            Zylon.addFlags(DISABLE_REPLICATION);
            SupercriticalSteam.addFlags(DISABLE_REPLICATION);
            SodiumPotassiumAlloy.addFlags(DISABLE_REPLICATION);
            SupercriticalSodiumPotassiumAlloy.addFlags(DISABLE_REPLICATION);
            FLiNaK.addFlags(DISABLE_REPLICATION);
            SupercriticalFLiNaK.addFlags(DISABLE_REPLICATION);
            FLiBe.addFlags(DISABLE_REPLICATION);
            SupercriticalFLiBe.addFlags(DISABLE_REPLICATION);
            LeadBismuthEutectic.addFlags(DISABLE_REPLICATION);
            SupercriticalLeadBismuthEutectic.addFlags(DISABLE_REPLICATION);
            HastelloyN.addFlags(DISABLE_REPLICATION);
            HeavyQuarkDegenerateMatter.addFlags(DISABLE_REPLICATION);
            MetastableFlerovium.addFlags(DISABLE_REPLICATION);
            QCDMatter.addFlags(DISABLE_REPLICATION);
            TitanSteel.addFlags(DISABLE_REPLICATION);
            MetastableHassium.addFlags(DISABLE_REPLICATION);
            TriniumTitanium.addFlags(DISABLE_REPLICATION);
            TantalumHafniumSeaborgiumCarbide.addFlags(DISABLE_REPLICATION);
            Nitinol60.addFlags(DISABLE_REPLICATION);
            ActiniumSuperhydride.addFlags(DISABLE_REPLICATION);
            BETSPerrhenate.addFlags(DISABLE_REPLICATION);
            BorocarbideDust.addFlags(DISABLE_REPLICATION);
            FullereneSuperconductiveDust.addFlags(DISABLE_REPLICATION);
            ProtoAdamantium.addFlags(DISABLE_REPLICATION);
            SuperheavyHAlloy.addFlags(DISABLE_REPLICATION);
            RheniumHassiumThalliumIsophtaloylbisdiethylthioureaHexafluorophosphate.addFlags(DISABLE_REPLICATION);
            Legendarium.addFlags(DISABLE_REPLICATION);
            LanthanumFullereneMix.addFlags(DISABLE_REPLICATION);
            LanthanumFullereneNanotubes.addFlags(DISABLE_REPLICATION);
            SuperheavyLAlloy.addFlags(DISABLE_REPLICATION);
            HexanitroHexaazaisowurtzitane.addFlags(DISABLE_REPLICATION);
            ElectronDegenerateRheniumPlasma.addFlags(DISABLE_REPLICATION, DISABLE_DECONSTRUCTION);
            SuperheavyMix.addFlags(DISABLE_REPLICATION);
            NeutronPlasma.addFlags(DISABLE_REPLICATION, DISABLE_DECONSTRUCTION);
            FreeAlphaGas.addFlags(DISABLE_REPLICATION);
            FreeElectronGas.addFlags(DISABLE_REPLICATION);
            PotassiumCarbonate.addFlags(DISABLE_REPLICATION);
            PotassiumBisulfite.addFlags(DISABLE_REPLICATION);
            PotassiumNitrite.addFlags(DISABLE_REPLICATION);
            AceticAnhydride.addFlags(DISABLE_REPLICATION);
            SodiumAcetate.addFlags(DISABLE_REPLICATION);
            PotassiumHydroxylaminedisulfonate.addFlags(DISABLE_REPLICATION);
            BariumChloride.addFlags(DISABLE_REPLICATION);
            BariumSulfateSolution.addFlags(DISABLE_REPLICATION);
            HydroxylamineHydrochloride.addFlags(DISABLE_REPLICATION);
            MaleicAnhydride.addFlags(DISABLE_REPLICATION);
            SuccinicAcid.addFlags(DISABLE_REPLICATION);
            SuccinicAnhydride.addFlags(DISABLE_REPLICATION);
            Tetrahydrofuran.addFlags(DISABLE_REPLICATION);
            NHydroxysuccinimide.addFlags(DISABLE_REPLICATION);
            Triethylamine.addFlags(DISABLE_REPLICATION);
            SuccinimidylAcetate.addFlags(DISABLE_REPLICATION);
            SeleniumOxide.addFlags(DISABLE_REPLICATION);
            SelenousAcid.addFlags(DISABLE_REPLICATION);
            AmmoniumAcetate.addFlags(DISABLE_REPLICATION);
            Acetamide.addFlags(DISABLE_REPLICATION);
            Acetonitrile.addFlags(DISABLE_REPLICATION);
            BenzylChloride.addFlags(DISABLE_REPLICATION);
            Hexamethylenetetramine.addFlags(DISABLE_REPLICATION);
            Benzylamine.addFlags(DISABLE_REPLICATION);
            Glyoxal.addFlags(DISABLE_REPLICATION);
            Hexabenzylhexaazaisowurtzitane.addFlags(DISABLE_REPLICATION);
            PalladiumChloride.addFlags(DISABLE_REPLICATION);
            PdCCatalyst.addFlags(DISABLE_REPLICATION);
            HydrobromicAcid.addFlags(DISABLE_REPLICATION);
            Dimethylformamide.addFlags(DISABLE_REPLICATION);
            DibenzylTetraacetylhexaazaisowurtzitane.addFlags(DISABLE_REPLICATION);
            NitroniumTetrafluoroborate.addFlags(DISABLE_REPLICATION);
            NitrosoniumTetrafluoroborate.addFlags(DISABLE_REPLICATION);
            Tetraacetyldinitrosohexaazaisowurtzitane.addFlags(DISABLE_REPLICATION);
            SilverOxide.addFlags(DISABLE_REPLICATION);
            Silvertetrafluoroborate.addFlags(DISABLE_REPLICATION);
            TetrafluoroboricAcid.addFlags(DISABLE_REPLICATION);
            Benzaldehyde.addFlags(DISABLE_REPLICATION);
            CrudeHexanitroHexaazaisowurtzitane.addFlags(DISABLE_REPLICATION);
            SilicaGel.addFlags(DISABLE_REPLICATION);
            BrevibacteriumFlavium.addFlags(DISABLE_REPLICATION);
            Succinimide.addFlags(DISABLE_REPLICATION);
            Acetaldehyde.addFlags(DISABLE_REPLICATION);
            Trichloroferane.addFlags(DISABLE_REPLICATION);
            SeaborgiumDopedNanotubes.addFlags(DISABLE_REPLICATION);
            PrHoYLF.addFlags(DISABLE_REPLICATION);
            LuTmYVO.addFlags(DISABLE_REPLICATION);
            NeodymiumDopedYttrium.addFlags(DISABLE_REPLICATION);
            UnprocessedNdYAGSolution.addFlags(DISABLE_REPLICATION);
            UnprocessedNdYAGDust.addFlags(DISABLE_REPLICATION);
            NdYAGNanoparticles.addFlags(DISABLE_REPLICATION);
            NdYAG.addFlags(DISABLE_REPLICATION);
            Pyrotheum.addFlags(DISABLE_REPLICATION);
            Cryotheum.addFlags(DISABLE_REPLICATION);
            DrillingMud.addFlags(DISABLE_REPLICATION);
            UsedDrillingMud.addFlags(DISABLE_REPLICATION);
            HastelloyX78.addFlags(DISABLE_REPLICATION);
            Incoloy813.addFlags(DISABLE_REPLICATION);
            Staballoy.addFlags(DISABLE_REPLICATION);
            OrthoXyleneZeoliteMixture.addFlags(DISABLE_REPLICATION);
            ParaXylene.addFlags(DISABLE_REPLICATION);
            Dibromomethylbenzene.addFlags(DISABLE_REPLICATION);
            Terephthalaldehyde.addFlags(DISABLE_REPLICATION);
            AuPdCCatalyst.addFlags(DISABLE_REPLICATION);
            Isochloropropane.addFlags(DISABLE_REPLICATION);
            Dinitrodipropanyloxybenzene.addFlags(DISABLE_REPLICATION);
            PreZylon.addFlags(DISABLE_REPLICATION);
            Soap.addFlags(DISABLE_REPLICATION);
            DeglyceratedSoap.addFlags(DISABLE_REPLICATION);
            StearicAcid.addFlags(DISABLE_REPLICATION);
            Trioctylphosphine.addFlags(DISABLE_REPLICATION);
            QuantumDots.addFlags(DISABLE_REPLICATION);
            Enderium.addFlags(DISABLE_REPLICATION);
            PreciousMetals.addFlags(DISABLE_REPLICATION);
            RefractoryMetals.addFlags(DISABLE_REPLICATION);
            LightTranstionMetals.addFlags(DISABLE_REPLICATION);
            Alkalis.addFlags(DISABLE_REPLICATION);
            PostTransitionMetals.addFlags(DISABLE_REPLICATION);
            Lanthanoids.addFlags(DISABLE_REPLICATION);
            Actinoids.addFlags(DISABLE_REPLICATION);
            NonMetals.addFlags(DISABLE_REPLICATION);
            NobleGases.addFlags(DISABLE_REPLICATION);
            Periodicium.addFlags(DISABLE_REPLICATION);
            HeavyLeptonMix.addFlags(DISABLE_REPLICATION);
            Gluons.addFlags(DISABLE_REPLICATION);
            DenseNeutronPlasma.addFlags(DISABLE_REPLICATION, DISABLE_DECONSTRUCTION);
            SuperfluidHelium.addFlags(DISABLE_REPLICATION);
            Cycloparaphenylene.addFlags(DISABLE_REPLICATION);
            NeutroniumDopedNanotubes.addFlags(DISABLE_REPLICATION);
            CosmicMeshPlasma.addFlags(DISABLE_REPLICATION, DISABLE_DECONSTRUCTION);
            AcidicSaltWater.addFlags(DISABLE_REPLICATION);
            SulfuricBromineSolution.addFlags(DISABLE_REPLICATION);
            DebrominatedWater.addFlags(DISABLE_REPLICATION);
            HotVapourMixture.addFlags(DISABLE_REPLICATION);
            Ethylhexanol.addFlags(DISABLE_REPLICATION);
            DampBromine.addFlags(DISABLE_REPLICATION);
            DiethylhexylPhosphoricAcid.addFlags(DISABLE_REPLICATION);
            SodiumHydroxideSolution.addFlags(DISABLE_REPLICATION);
            RareEarthHydroxidesSolution.addFlags(DISABLE_REPLICATION);
            RareEarthChloridesSolution.addFlags(DISABLE_REPLICATION);
            ThUSludge.addFlags(DISABLE_REPLICATION);
            LaNdOxidesSolution.addFlags(DISABLE_REPLICATION);
            SmGdOxidesSolution.addFlags(DISABLE_REPLICATION);
            TbHoOxidesSolution.addFlags(DISABLE_REPLICATION);
            ErLuOxidesSolution.addFlags(DISABLE_REPLICATION);
            LanthanumOxide.addFlags(DISABLE_REPLICATION);
            CeriumOxide.addFlags(DISABLE_REPLICATION);
            ScandiumOxide.addFlags(DISABLE_REPLICATION);
            EuropiumOxide.addFlags(DISABLE_REPLICATION);
            GadoliniumOxide.addFlags(DISABLE_REPLICATION);
            SamariumOxide.addFlags(DISABLE_REPLICATION);
            TerbiumOxide.addFlags(DISABLE_REPLICATION);
            DysprosiumOxide.addFlags(DISABLE_REPLICATION);
            ErbiumOxide.addFlags(DISABLE_REPLICATION);
            YtterbiumOxide.addFlags(DISABLE_REPLICATION);
            Dimethylether.addFlags(DISABLE_REPLICATION);
            EthyleneOxide.addFlags(DISABLE_REPLICATION);
            Dimethoxyethane.addFlags(DISABLE_REPLICATION);
            Cyclooctadiene.addFlags(DISABLE_REPLICATION);
            Cyclopentadiene.addFlags(DISABLE_REPLICATION);
            ButylLithium.addFlags(DISABLE_REPLICATION);
            LithiumCyclopentadienide.addFlags(DISABLE_REPLICATION);
            GoldCyanide.addFlags(DISABLE_REPLICATION);
            GoldDepleteMolybdenite.addFlags(DISABLE_REPLICATION);
            MolybdenumConcentrate.addFlags(DISABLE_REPLICATION);
            ChlorideLeachedSolution.addFlags(DISABLE_REPLICATION);
            CopperChloride.addFlags(DISABLE_REPLICATION);
            LeadChloride.addFlags(DISABLE_REPLICATION);
            BismuthChloride.addFlags(DISABLE_REPLICATION);
            Iron2Chloride.addFlags(DISABLE_REPLICATION);
            MolybdenumFlue.addFlags(DISABLE_REPLICATION);
            MolybdenumTrioxide.addFlags(DISABLE_REPLICATION);
            RheniumSulfuricSolution.addFlags(DISABLE_REPLICATION);
            AmmoniumPerrhenate.addFlags(DISABLE_REPLICATION);
            MercuryAcetate.addFlags(DISABLE_REPLICATION);
            Methylamine.addFlags(DISABLE_REPLICATION);
            Methylethanolamine.addFlags(DISABLE_REPLICATION);
            CalciumCarbide.addFlags(DISABLE_REPLICATION);
            CalciumCyanamide.addFlags(DISABLE_REPLICATION);
            Methylguanidine.addFlags(DISABLE_REPLICATION);
            Methylnitronitrosoguanidine.addFlags(DISABLE_REPLICATION);
            CupriavidusNecator.addFlags(DISABLE_REPLICATION);
            SelectivelyMutatedCupriavidiusNecator.addFlags(DISABLE_REPLICATION);
            IsoamylAlcohol.addFlags(DISABLE_REPLICATION);
            Oct1ene.addFlags(DISABLE_REPLICATION);
            Octanol.addFlags(DISABLE_REPLICATION);
            PalladiumLoadedRutileNanoparticles.addFlags(DISABLE_REPLICATION);
            Trioctylamine.addFlags(DISABLE_REPLICATION);
            Kerosene.addFlags(DISABLE_REPLICATION);
            MesitylOxide.addFlags(DISABLE_REPLICATION);
            MethylIsobutylKetone.addFlags(DISABLE_REPLICATION);
            PlatinumSalt.addFlags(DISABLE_REPLICATION);
            RheniumSeparationMixture.addFlags(DISABLE_REPLICATION);
            RheniumScrubbedSolution.addFlags(DISABLE_REPLICATION);
            LeachedColumbite.addFlags(DISABLE_REPLICATION);
            PurifiedColumbite.addFlags(DISABLE_REPLICATION);
            LeachedPyrochlore.addFlags(DISABLE_REPLICATION);
            PurifiedPyrochlore.addFlags(DISABLE_REPLICATION);
            Glucose.addFlags(DISABLE_REPLICATION);
            FluoroniobicAcid.addFlags(DISABLE_REPLICATION);
            PlatinumSaltRefined.addFlags(DISABLE_REPLICATION);
            DirtyHexafluorosilicicAcid.addFlags(DISABLE_REPLICATION);
            StoneResidueDust.addFlags(DISABLE_REPLICATION);
            DiluteHexafluorosilicicAcid.addFlags(DISABLE_REPLICATION);
            Triniite.addFlags(DISABLE_REPLICATION);
            UncommonResidues.addFlags(DISABLE_REPLICATION);
            RedMud.addFlags(DISABLE_REPLICATION);
            Dioxygendifluoride.addFlags(DISABLE_REPLICATION);
            PartiallyOxidizedResidues.addFlags(DISABLE_REPLICATION);
            OxidizedResidualSolution.addFlags(DISABLE_REPLICATION);
            InertResidues.addFlags(DISABLE_REPLICATION);
            CleanInertResidues.addFlags(DISABLE_REPLICATION);
            NaquadricCompound.addFlags(DISABLE_REPLICATION);
            EnrichedNaquadricCompound.addFlags(DISABLE_REPLICATION);
            NaquadriaticCompound.addFlags(DISABLE_REPLICATION);
            DiamagneticResidues.addFlags(DISABLE_REPLICATION);
            ParamagneticResidues.addFlags(DISABLE_REPLICATION);
            FerromagneticResidues.addFlags(DISABLE_REPLICATION);
            OxidizedResidues.addFlags(DISABLE_REPLICATION);
            HeavyOxidizedResidues.addFlags(DISABLE_REPLICATION);
            MetallicResidues.addFlags(DISABLE_REPLICATION);
            HeavyDiamagneticResidues.addFlags(DISABLE_REPLICATION);
            HeavyParamagneticResidues.addFlags(DISABLE_REPLICATION);
            HeavyFerromagneticResidues.addFlags(DISABLE_REPLICATION);
            HeavyMetallicResidues.addFlags(DISABLE_REPLICATION);
            NitratedTriniiteSolution.addFlags(DISABLE_REPLICATION);
            ExoticHeavyResidues.addFlags(DISABLE_REPLICATION);
            DiluteHydrofluoricAcid.addFlags(DISABLE_REPLICATION);
            TritiumHydride.addFlags(DISABLE_REPLICATION);
            Helium3Hydride.addFlags(DISABLE_REPLICATION);
            UltraacidicResidueSolution.addFlags(DISABLE_REPLICATION);
            XenicAcid.addFlags(DISABLE_REPLICATION);
            DustyLiquidHelium3.addFlags(DISABLE_REPLICATION);
            Ozone.addFlags(DISABLE_REPLICATION);
            TaraniumEnrichedLHelium3.addFlags(DISABLE_REPLICATION);
            TaraniumSemidepletedLHelium3.addFlags(DISABLE_REPLICATION);
            TaraniumDepletedLHelium3.addFlags(DISABLE_REPLICATION);
            TaraniumRichDustyHeliumPlasma.addFlags(DISABLE_REPLICATION, DISABLE_DECONSTRUCTION);
            TaraniumRichHelium4.addFlags(DISABLE_REPLICATION);
            TaraniumDepletedHeliumPlasma.addFlags(DISABLE_REPLICATION, DISABLE_DECONSTRUCTION);
            TaraniumPoorLiquidHelium.addFlags(DISABLE_REPLICATION);
            TaraniumPoorLiquidHeliumMix.addFlags(DISABLE_REPLICATION);
            BariumOxide.addFlags(DISABLE_REPLICATION);
            BariumStrontiumAcetateSolution.addFlags(DISABLE_REPLICATION);
            IsopropylAlcohol.addFlags(DISABLE_REPLICATION);
            TitaniumIsopropoxide.addFlags(DISABLE_REPLICATION);
            BariumStrontiumTitanatePreparation.addFlags(DISABLE_REPLICATION);
            BariumStrontiumTitanate.addFlags(DISABLE_REPLICATION);
            IsopropylAcetate.addFlags(DISABLE_REPLICATION);
            PotasssiumFluoroTantalate.addFlags(DISABLE_REPLICATION);
            LeadNitrate.addFlags(DISABLE_REPLICATION);
            LeadNitrateCalciumMixture.addFlags(DISABLE_REPLICATION);
            LeadScandiumTantalate.addFlags(DISABLE_REPLICATION);
            MagnetorestrictiveAlloy.addFlags(DISABLE_REPLICATION);
            LeadSenenide.addFlags(DISABLE_REPLICATION);
            ZincSelenide.addFlags(DISABLE_REPLICATION);
            FranciumCaesiumCadmiumBromide.addFlags(DISABLE_REPLICATION);
            SodiumIodide.addFlags(DISABLE_REPLICATION);
            Iodobenzene.addFlags(DISABLE_REPLICATION);
            PalladiumAcetate.addFlags(DISABLE_REPLICATION);
            Stilbene.addFlags(DISABLE_REPLICATION);
            Aminophenol.addFlags(DISABLE_REPLICATION);
            Amino3phenol.addFlags(DISABLE_REPLICATION);
            Ethylamine.addFlags(DISABLE_REPLICATION);
            SodiumAzanide.addFlags(DISABLE_REPLICATION);
            PhthalicAnhydride.addFlags(DISABLE_REPLICATION);
            TetraethylammoniumNonahydridides.addFlags(DISABLE_REPLICATION);
            RhodamineB.addFlags(DISABLE_REPLICATION);
            Hydroxylamine.addFlags(DISABLE_REPLICATION);
            SodiumPertechnetate.addFlags(DISABLE_REPLICATION);
            PotassiumPerrhenate.addFlags(DISABLE_REPLICATION);
            PotassiumPertechnate.addFlags(DISABLE_REPLICATION);
            PotassiumNonahydridorhenate.addFlags(DISABLE_REPLICATION);
            PotassiumEthoxide.addFlags(DISABLE_REPLICATION);
            PotassiumNonahydridotechnetate.addFlags(DISABLE_REPLICATION);
            TetraethylammoniumBromide.addFlags(DISABLE_REPLICATION);
            PotassiumIodide.addFlags(DISABLE_REPLICATION);
            Butylaniline.addFlags(DISABLE_REPLICATION);
            LithiumIodide.addFlags(DISABLE_REPLICATION);
            Trimethylchlorosilane.addFlags(DISABLE_REPLICATION);
            Trimethylsilane.addFlags(DISABLE_REPLICATION);
            PotassiumBromide.addFlags(DISABLE_REPLICATION);
            PotassiumBromate.addFlags(DISABLE_REPLICATION);
            IodobenzoicAcid.addFlags(DISABLE_REPLICATION);
            IBX.addFlags(DISABLE_REPLICATION);
            Methoxybenzaldehyde.addFlags(DISABLE_REPLICATION);
            MBBA.addFlags(DISABLE_REPLICATION);
            LiquidCrystalDetector.addFlags(DISABLE_REPLICATION);
            IodineMonochloride.addFlags(DISABLE_REPLICATION);
            RhReNqCatalyst.addFlags(DISABLE_REPLICATION);
            AcetylatingReagent.addFlags(DISABLE_REPLICATION);
            Dimethylnaphthalene.addFlags(DISABLE_REPLICATION);
            Bromosuccinimide.addFlags(DISABLE_REPLICATION);
            Dihydroiodotetracene.addFlags(DISABLE_REPLICATION);
            Dichlorodicyanobenzoquinone.addFlags(DISABLE_REPLICATION);
            VanadiumOxide.addFlags(DISABLE_REPLICATION);
            LithiumChlorideSolution.addFlags(DISABLE_REPLICATION);
            Dichlorodicyanohydroquinone.addFlags(DISABLE_REPLICATION);
            Tetracene.addFlags(DISABLE_REPLICATION);
            StreptococcusPyogenes.addFlags(DISABLE_REPLICATION);
            BifidobacteriumBreve.addFlags(DISABLE_REPLICATION);
            EschericiaColi.addFlags(DISABLE_REPLICATION);
            SodiumHypochlorite.addFlags(DISABLE_REPLICATION);
            HotNitrogen.addFlags(DISABLE_REPLICATION);
            Lignite.addFlags(DISABLE_REPLICATION);
            DehydratedLignite.addFlags(DISABLE_REPLICATION);
            BCEPellet.addFlags(DISABLE_REPLICATION);
            GlucoseIronSolution.addFlags(DISABLE_REPLICATION);
            GrapheneOxidationSolution.addFlags(DISABLE_REPLICATION);
            GraphiteOxide.addFlags(DISABLE_REPLICATION);
            GrapheneOxidationResidue.addFlags(DISABLE_REPLICATION);
            GrapheneOxide.addFlags(DISABLE_REPLICATION);
            Hydrazine.addFlags(DISABLE_REPLICATION);
            Snow.addFlags(DISABLE_REPLICATION);
            SupercooledCryotheum.addFlags(DISABLE_REPLICATION);
            RedOil.addFlags(DISABLE_REPLICATION);
            RP1.addFlags(DISABLE_REPLICATION);
            TributylPhosphate.addFlags(DISABLE_REPLICATION);
            PhosphorusTrichloride.addFlags(DISABLE_REPLICATION);
            PhosphorylChloride.addFlags(DISABLE_REPLICATION);
            SodiumFormate.addFlags(DISABLE_REPLICATION);
            FormicAcid.addFlags(DISABLE_REPLICATION);
            OrganicFertilizer.addFlags(DISABLE_REPLICATION);
            CarbonFluoride.addFlags(DISABLE_REPLICATION);
            CalciumCarbonateSolution.addFlags(DISABLE_REPLICATION);
            BentoniteClaySlurry.addFlags(DISABLE_REPLICATION);
            AluminiumChloride.addFlags(DISABLE_REPLICATION);
            EthylAnthraQuinone.addFlags(DISABLE_REPLICATION);
            EthylAnthraHydroQuinone.addFlags(DISABLE_REPLICATION);
            Anthracene.addFlags(DISABLE_REPLICATION);
            Chloroethanol.addFlags(DISABLE_REPLICATION);
            Trimethylamine.addFlags(DISABLE_REPLICATION);
            Choline.addFlags(DISABLE_REPLICATION);
            ATL.addFlags(DISABLE_REPLICATION);
            EthyleneGlycol.addFlags(DISABLE_REPLICATION);
            CaCBaSMixture.addFlags(DISABLE_REPLICATION);
            LubricantClaySlurry.addFlags(DISABLE_REPLICATION);
            ATLEthylene.addFlags(DISABLE_REPLICATION);
            DrillingMudMixture.addFlags(DISABLE_REPLICATION);
            WetEthyleneOxide.addFlags(DISABLE_REPLICATION);
            Phosgene.addFlags(DISABLE_REPLICATION);
            TolueneDiisocyanate.addFlags(DISABLE_REPLICATION);
            Polyurethane.addFlags(DISABLE_REPLICATION);
            ViscoelasticPolyurethane.addFlags(DISABLE_REPLICATION);
            ViscoelasticPolyurethaneFoam.addFlags(DISABLE_REPLICATION);
            RocketFuelH8N4C2O4.addFlags(DISABLE_REPLICATION);
            MonoMethylHydrazine.addFlags(DISABLE_REPLICATION);
            RocketFuelCN3H7O3.addFlags(DISABLE_REPLICATION);
            DenseHydrazineFuelMixture.addFlags(DISABLE_REPLICATION);
            RP1RocketFuel.addFlags(DISABLE_REPLICATION);
            CoalTarOil.addFlags(DISABLE_REPLICATION);
            SulfuricCoalTarOil.addFlags(DISABLE_REPLICATION);
            AluminiumHydroxide.addFlags(DISABLE_REPLICATION);
            SodiumHexafluoroaluminate.addFlags(DISABLE_REPLICATION);
            SodiumHydroxideBauxite.addFlags(DISABLE_REPLICATION);
            ImpureAluminiumHydroxideSolution.addFlags(DISABLE_REPLICATION);
            PureAluminiumHydroxideSolution.addFlags(DISABLE_REPLICATION);
            NeutralisedRedMud.addFlags(DISABLE_REPLICATION);
            RedSlurry.addFlags(DISABLE_REPLICATION);
            FerricREEChloride.addFlags(DISABLE_REPLICATION);
            TitanylSulfate.addFlags(DISABLE_REPLICATION);
            NiAlOCatalyst.addFlags(DISABLE_REPLICATION);
            RichNitrogenMix.addFlags(DISABLE_REPLICATION);
            FeCrOCatalyst.addFlags(DISABLE_REPLICATION);
            OxidisedNitrogenMix.addFlags(DISABLE_REPLICATION);
            PurifiedNitrogenMix.addFlags(DISABLE_REPLICATION);
            CarbonatedEthanolamine.addFlags(DISABLE_REPLICATION);
            AmmoniaRichMix.addFlags(DISABLE_REPLICATION);
            BariumCarbonate.addFlags(DISABLE_REPLICATION);
            BariumAluminate.addFlags(DISABLE_REPLICATION);
            Barytocalcite.addFlags(DISABLE_REPLICATION);
            Witherite.addFlags(DISABLE_REPLICATION);
            AcryloNitrile.addFlags(DISABLE_REPLICATION);
            SodiumThiocyanate.addFlags(DISABLE_REPLICATION);
            PolyacrylonitrileSolution.addFlags(DISABLE_REPLICATION);
            AcrylicFibers.addFlags(DISABLE_REPLICATION);
            MethylFormate.addFlags(DISABLE_REPLICATION);
            WetFormamide.addFlags(DISABLE_REPLICATION);
            Formamide.addFlags(DISABLE_REPLICATION);
            HydroxylamineDisulfate.addFlags(DISABLE_REPLICATION);
            Amidoxime.addFlags(DISABLE_REPLICATION);
            SeaWater.addFlags(DISABLE_REPLICATION);
            PureUranylNitrateSolution.addFlags(DISABLE_REPLICATION);
            UranylNitrate.addFlags(DISABLE_REPLICATION);
            DiluteNitricAcid.addFlags(DISABLE_REPLICATION);
            Brine.addFlags(DISABLE_REPLICATION);
            ConcentratedBrine.addFlags(DISABLE_REPLICATION);
            BrominatedBrine.addFlags(DISABLE_REPLICATION);
            AcidicBrominatedBrine.addFlags(DISABLE_REPLICATION);
            CalciumFreeBrine.addFlags(DISABLE_REPLICATION);
            CalciumSalts.addFlags(DISABLE_REPLICATION);
            SodiumFreeBrine.addFlags(DISABLE_REPLICATION);
            SodiumSalts.addFlags(DISABLE_REPLICATION);
            PotassiumFreeBrine.addFlags(DISABLE_REPLICATION);
            PotassiumMagnesiumSalts.addFlags(DISABLE_REPLICATION);
            BoronFreeSolution.addFlags(DISABLE_REPLICATION);
            CalciumMagnesiumSalts.addFlags(DISABLE_REPLICATION);
            SodiumLithiumSolution.addFlags(DISABLE_REPLICATION);
            SodiumAluminiumHydride.addFlags(DISABLE_REPLICATION);
            Cellulose.addFlags(DISABLE_REPLICATION);
            Fructose.addFlags(DISABLE_REPLICATION);
            SodiumAzide.addFlags(DISABLE_REPLICATION);
            LithiumHydroxideSolution.addFlags(DISABLE_REPLICATION);
            Glucosamine.addFlags(DISABLE_REPLICATION);
            Chitosan.addFlags(DISABLE_REPLICATION);
            SodiumSulfate.addFlags(DISABLE_REPLICATION);
            SodiumSulfateSolution.addFlags(DISABLE_REPLICATION);
            BoronOxide.addFlags(DISABLE_REPLICATION);
            Diborane.addFlags(DISABLE_REPLICATION);
            LithiumAluminiumFluoride.addFlags(DISABLE_REPLICATION);
            CarbonSulfide.addFlags(DISABLE_REPLICATION);
            DimethylthiocarbamoilChloride.addFlags(DISABLE_REPLICATION);
            Mercaptophenol.addFlags(DISABLE_REPLICATION);
            AmineMixture.addFlags(DISABLE_REPLICATION);
            SodiumMolybdate.addFlags(DISABLE_REPLICATION);
            SodiumPhosphomolybdate.addFlags(DISABLE_REPLICATION);
            SodiumTungstate.addFlags(DISABLE_REPLICATION);
            SodiumPhosphotungstate.addFlags(DISABLE_REPLICATION);
            Dichlorocycloctadieneplatinium.addFlags(DISABLE_REPLICATION);
            IridiumCyclooctadienylChlorideDimer.addFlags(DISABLE_REPLICATION);
            ChlorodiisopropylPhosphine.addFlags(DISABLE_REPLICATION);
            DehydrogenationCatalyst.addFlags(DISABLE_REPLICATION);
            AmmoniumPersulfate.addFlags(DISABLE_REPLICATION);
            PolystyreneNanoParticles.addFlags(DISABLE_REPLICATION);
            Celestine.addFlags(DISABLE_REPLICATION);
            MagnesiumSulfate.addFlags(DISABLE_REPLICATION);
            StrontiumCarbonate.addFlags(DISABLE_REPLICATION);
            StrontiumOxide.addFlags(DISABLE_REPLICATION);
            ChilledBrine.addFlags(DISABLE_REPLICATION);
            MagnesiumContainingBrine.addFlags(DISABLE_REPLICATION);
            PotassiumFluoride.addFlags(DISABLE_REPLICATION);
            SodiumCarbonateSolution.addFlags(DISABLE_REPLICATION);
            SodiumChromateSolution.addFlags(DISABLE_REPLICATION);
            SodiumDichromateSolution.addFlags(DISABLE_REPLICATION);
            ChromiumIIIOxide.addFlags(DISABLE_REPLICATION);
            Naphthaldehyde.addFlags(DISABLE_REPLICATION);
            Benzophenanthrenylacetonitrile.addFlags(DISABLE_REPLICATION);
            UnfoldedFullerene.addFlags(DISABLE_REPLICATION);
            PotassiumPeroxymonosulfate.addFlags(DISABLE_REPLICATION);
            AuricChloride.addFlags(DISABLE_REPLICATION);
            XenonTrioxide.addFlags(DISABLE_REPLICATION);
            RadonTrioxide.addFlags(DISABLE_REPLICATION);
            Fullerene.addFlags(DISABLE_REPLICATION);
            Ferrocene.addFlags(DISABLE_REPLICATION);
            SodiumEthoxide.addFlags(DISABLE_REPLICATION);
            PdFullereneMatrix.addFlags(DISABLE_REPLICATION);
            Pyridine.addFlags(DISABLE_REPLICATION);
            Dimethylaminopyridine.addFlags(DISABLE_REPLICATION);
            Phenylpentanoicacid.addFlags(DISABLE_REPLICATION);
            Dimethylsulfide.addFlags(DISABLE_REPLICATION);
            PCBA.addFlags(DISABLE_REPLICATION);
            PCBS.addFlags(DISABLE_REPLICATION);
            QuarkGluonPlasma.addFlags(DISABLE_REPLICATION);
            HeavyQuarks.addFlags(DISABLE_REPLICATION);
            LightQuarks.addFlags(DISABLE_REPLICATION);
            CosmicComputingMix.addFlags(DISABLE_REPLICATION);
            HeavyQuarkEnrichedMix.addFlags(DISABLE_REPLICATION);
            Titanium50.addFlags(DISABLE_REPLICATION);
            ScandiumTitanium50Mix.addFlags(DISABLE_REPLICATION);
            RadonRadiumMix.addFlags(DISABLE_REPLICATION);
            DeuteriumSuperheavyMix.addFlags(DISABLE_REPLICATION);
            Phenylsodium.addFlags(DISABLE_REPLICATION);
            Succinaldehyde.addFlags(DISABLE_REPLICATION);
            Difluoroaniline.addFlags(DISABLE_REPLICATION);
            NDifluorophenylpyrrole.addFlags(DISABLE_REPLICATION);
            SilverChloride.addFlags(DISABLE_REPLICATION);
            SilverPerchlorate.addFlags(DISABLE_REPLICATION);
            TitaniumCyclopentadienyl.addFlags(DISABLE_REPLICATION);
            SodiumBromide.addFlags(DISABLE_REPLICATION);
            PhotopolymerSolution.addFlags(DISABLE_REPLICATION);
            SodiumChlorate.addFlags(DISABLE_REPLICATION);
            SodiumPerchlorate.addFlags(DISABLE_REPLICATION);
            GermaniumOxide.addFlags(DISABLE_REPLICATION);
            GermaniumSulfide.addFlags(DISABLE_REPLICATION);
            TungstenTrioxide.addFlags(DISABLE_REPLICATION);
            CadmiumSulfide.addFlags(DISABLE_REPLICATION);
            CalciumTungstate.addFlags(DISABLE_REPLICATION);
            CadmiumTungstate.addFlags(DISABLE_REPLICATION);
            CesiumIodide.addFlags(DISABLE_REPLICATION);
            TlTmCesiumIodide.addFlags(DISABLE_REPLICATION);
            PolycyclicAromaticMix.addFlags(DISABLE_REPLICATION);
            BismuthNitrateSoluton.addFlags(DISABLE_REPLICATION);
            BismuthGermanate.addFlags(DISABLE_REPLICATION);
            DisodiumPhosphate.addFlags(DISABLE_REPLICATION);
            Cyanonaphthalene.addFlags(DISABLE_REPLICATION);
            TinChloride.addFlags(DISABLE_REPLICATION);
            Triphenylphosphine.addFlags(DISABLE_REPLICATION);
            Methylbenzophenanthrene.addFlags(DISABLE_REPLICATION);
            PotassiumCyanide.addFlags(DISABLE_REPLICATION);
            TiAlChloride.addFlags(DISABLE_REPLICATION);
            ThionylChloride.addFlags(DISABLE_REPLICATION);
            ZeoliteSievingPellets.addFlags(DISABLE_REPLICATION);
            WetZeoliteSievingPellets.addFlags(DISABLE_REPLICATION);
            PdIrReOCeOS.addFlags(DISABLE_REPLICATION);
            Ferrocenylfulleropyrrolidine.addFlags(DISABLE_REPLICATION);
            BenzoylChloride.addFlags(DISABLE_REPLICATION);
            BenzoylPeroxide.addFlags(DISABLE_REPLICATION);
            HydroiodicAcid.addFlags(DISABLE_REPLICATION);
            TrimethyltinChloride.addFlags(DISABLE_REPLICATION);
            Diisopropylcarbodiimide.addFlags(DISABLE_REPLICATION);
            Hexanediol.addFlags(DISABLE_REPLICATION);
            Hexamethylenediamine.addFlags(DISABLE_REPLICATION);
            SaccharicAcid.addFlags(DISABLE_REPLICATION);
            AdipicAcid.addFlags(DISABLE_REPLICATION);
            Tertbutanol.addFlags(DISABLE_REPLICATION);
            DitertbutylDicarbonate.addFlags(DISABLE_REPLICATION);
            Triaminoethaneamine.addFlags(DISABLE_REPLICATION);
            TertButylAzidoformate.addFlags(DISABLE_REPLICATION);
            AminatedFullerene.addFlags(DISABLE_REPLICATION);
            Azafullerene.addFlags(DISABLE_REPLICATION);
            GrapheneGelSuspension.addFlags(DISABLE_REPLICATION);
            DryGrapheneGel.addFlags(DISABLE_REPLICATION);
            SupercriticalCO2.addFlags(DISABLE_REPLICATION);
            Caliche.addFlags(DISABLE_REPLICATION);
            CalicheIodateBrine.addFlags(DISABLE_REPLICATION);
            IodideSolution.addFlags(DISABLE_REPLICATION);
            CalicheIodineBrine.addFlags(DISABLE_REPLICATION);
            CalicheNitrateSolution.addFlags(DISABLE_REPLICATION);
            KeroseneIodineSolution.addFlags(DISABLE_REPLICATION);
            IodizedOil.addFlags(DISABLE_REPLICATION);
            IodizedBrine.addFlags(DISABLE_REPLICATION);
            IodineBrineMix.addFlags(DISABLE_REPLICATION);
            IodineSlurry.addFlags(DISABLE_REPLICATION);
            RoastedSpodumene.addFlags(DISABLE_REPLICATION);
            RoastedLepidolite.addFlags(DISABLE_REPLICATION);
            Fluorite.addFlags(DISABLE_REPLICATION);
            DissolvedLithiumOre.addFlags(DISABLE_REPLICATION);
            AluminiumSulfate.addFlags(DISABLE_REPLICATION);
            LithiumCarbonateSolution.addFlags(DISABLE_REPLICATION);
            Diiodobiphenyl.addFlags(DISABLE_REPLICATION);
            ThalliumChloride.addFlags(DISABLE_REPLICATION);
            NiAlCatalyst.addFlags(DISABLE_REPLICATION);
            Bipyridine.addFlags(DISABLE_REPLICATION);
            Dibenzylideneacetone.addFlags(DISABLE_REPLICATION);
            PalladiumBisDibenzylidieneacetone.addFlags(DISABLE_REPLICATION);
            ChloroPlatinicAcid.addFlags(DISABLE_REPLICATION);
            PotassiumTetrachloroplatinate.addFlags(DISABLE_REPLICATION);
            NickelChloride.addFlags(DISABLE_REPLICATION);
            NickelTriphenylPhosphite.addFlags(DISABLE_REPLICATION);
            GrapheneNanotubeMix.addFlags(DISABLE_REPLICATION);
            GrapheneAlignedCNT.addFlags(DISABLE_REPLICATION);
            Rhodocrosite.addFlags(DISABLE_REPLICATION);
            CassiteriteCokePellets.addFlags(DISABLE_REPLICATION);
            TinSlag.addFlags(DISABLE_REPLICATION);
            NbTaContainingDust.addFlags(DISABLE_REPLICATION);
            NiobiumTantalumOxide.addFlags(DISABLE_REPLICATION);
            NbTaFluorideMix.addFlags(DISABLE_REPLICATION);
            Columbite.addFlags(DISABLE_REPLICATION);
            FusedColumbite.addFlags(DISABLE_REPLICATION);
            BariumPeroxide.addFlags(DISABLE_REPLICATION);
            ColumbiteMinorOxideResidue.addFlags(DISABLE_REPLICATION);
            IronSulfateDust.addFlags(DISABLE_REPLICATION);
            FusedTantalite.addFlags(DISABLE_REPLICATION);
            TantaliteMinorOxideResidue.addFlags(DISABLE_REPLICATION);
            LeachedTantalite.addFlags(DISABLE_REPLICATION);
            FluorotantalicAcid.addFlags(DISABLE_REPLICATION);
            NbTaSeparationMixture.addFlags(DISABLE_REPLICATION);
            AcidicLeachedPyrochlore.addFlags(DISABLE_REPLICATION);
            REEThUSulfateSolution.addFlags(DISABLE_REPLICATION);
            AlkalineEarthSulfateSolution.addFlags(DISABLE_REPLICATION);
            UranylThoriumNitrate.addFlags(DISABLE_REPLICATION);
            RareEarthNitrateSolution.addFlags(DISABLE_REPLICATION);
            OxypentafluoroNiobate.addFlags(DISABLE_REPLICATION);
            HeptafluoroTantalate.addFlags(DISABLE_REPLICATION);
            PotasssiumFluoroNiobate.addFlags(DISABLE_REPLICATION);
            AluminoSilicateWool.addFlags(DISABLE_REPLICATION);
            ScandiumTriflate.addFlags(DISABLE_REPLICATION);
            Toluenesulfonate.addFlags(DISABLE_REPLICATION);
            Niter.addFlags(DISABLE_REPLICATION);
            ElectricallyImpureCopper.addFlags(DISABLE_REPLICATION);
            CopperRefiningSolution.addFlags(DISABLE_REPLICATION);
            AnodicSlime.addFlags(DISABLE_REPLICATION);
            SeleniteTelluriteMix.addFlags(DISABLE_REPLICATION);
            TelluriumOxide.addFlags(DISABLE_REPLICATION);
            SeleniteSolution.addFlags(DISABLE_REPLICATION);
            HydroselenicAcid.addFlags(DISABLE_REPLICATION);
            IronPlatinumCatalyst.addFlags(DISABLE_REPLICATION);
            Hydroxyquinoline.addFlags(DISABLE_REPLICATION);
            SodiumRuthenate.addFlags(DISABLE_REPLICATION);
            IridiumDioxide.addFlags(DISABLE_REPLICATION);
            BariumChlorideSolution.addFlags(DISABLE_REPLICATION);
            BariumTitanatePreparation.addFlags(DISABLE_REPLICATION);
            Perbromothiophene.addFlags(DISABLE_REPLICATION);
            Diethoxythiophene.addFlags(DISABLE_REPLICATION);
            EDOT.addFlags(DISABLE_REPLICATION);
            ZirconylChloride.addFlags(DISABLE_REPLICATION);
            WoodsGlass.addFlags(DISABLE_REPLICATION);
            IronIodide.addFlags(DISABLE_REPLICATION);
            ThalliumIodide.addFlags(DISABLE_REPLICATION);
            RubidiumIodide.addFlags(DISABLE_REPLICATION);
            IndiumIodide.addFlags(DISABLE_REPLICATION);
            GalliumIodide.addFlags(DISABLE_REPLICATION);
            ScandiumIodide.addFlags(DISABLE_REPLICATION);
            IronCarbonyl.addFlags(DISABLE_REPLICATION);
            PurifiedIronCarbonyl.addFlags(DISABLE_REPLICATION);
            CarbonylPurifiedIron.addFlags(DISABLE_REPLICATION);
            YttriumEuropiumVanadate.addFlags(DISABLE_REPLICATION);
            StrontiumChloride.addFlags(DISABLE_REPLICATION);
            StrontiumEuropiumAluminate.addFlags(DISABLE_REPLICATION);
            GreenHalideMix.addFlags(DISABLE_REPLICATION);
            RedHalideMix.addFlags(DISABLE_REPLICATION);
            BlueHalideMix.addFlags(DISABLE_REPLICATION);
            WhiteHalideMix.addFlags(DISABLE_REPLICATION);
            UVAHalideMix.addFlags(DISABLE_REPLICATION);
            ThoriumDopedTungsten.addFlags(DISABLE_REPLICATION);
            MaragingSteel250.addFlags(DISABLE_REPLICATION);
            Biperfluoromethanedisulfide.addFlags(DISABLE_REPLICATION);
        }
    }
    ...
    private static void register2() {
        ...
        if (GCYLCore.isModLoaded("materialreplication")) {
            ...
            CopperNitrate.addFlags(DISABLE_REPLICATION);
            YttriumNitrate.addFlags(DISABLE_REPLICATION);
            CitricAcid.addFlags(DISABLE_REPLICATION);
            WellMixedYBCOxides.addFlags(DISABLE_REPLICATION);
            PiledTBCC.addFlags(DISABLE_REPLICATION);
            ActiniumOxalate.addFlags(DISABLE_REPLICATION);
            ActiniumHydride.addFlags(DISABLE_REPLICATION);
            ActiniumSuperhydridePlasma.addFlags(DISABLE_REPLICATION, DISABLE_DECONSTRUCTION);
            LanthanumEmbeddedFullerene.addFlags(DISABLE_REPLICATION);
            Dibromoacrolein.addFlags(DISABLE_REPLICATION);
            SodiumThiosulfate.addFlags(DISABLE_REPLICATION);
            Chloroethane.addFlags(DISABLE_REPLICATION);
            Bromohydrothiine.addFlags(DISABLE_REPLICATION);
            Bromobutane.addFlags(DISABLE_REPLICATION);
            Lithiumthiinediselenide.addFlags(DISABLE_REPLICATION);
            Propadiene.addFlags(DISABLE_REPLICATION);
            BETS.addFlags(DISABLE_REPLICATION);
            FranciumCarbide.addFlags(DISABLE_REPLICATION);
            BoronFranciumCarbide.addFlags(DISABLE_REPLICATION);
            AstatideSolution.addFlags(DISABLE_REPLICATION);
            MixedAstatideSalts.addFlags(DISABLE_REPLICATION);
            SodiumIodate.addFlags(DISABLE_REPLICATION);
            CopperSulfateSolution.addFlags(DISABLE_REPLICATION);
            SodiumPeriodate.addFlags(DISABLE_REPLICATION);
            StrontiumSuperconductorDust.addFlags(DISABLE_REPLICATION);
            KryptonDifluoride.addFlags(DISABLE_REPLICATION);
            ManganeseFluoride.addFlags(DISABLE_REPLICATION);
            PhenylenedioxydiaceticAcid.addFlags(DISABLE_REPLICATION);
            Diethylthiourea.addFlags(DISABLE_REPLICATION);
            Isophthaloylbisdiethylthiourea.addFlags(DISABLE_REPLICATION);
            HassiumChloride.addFlags(DISABLE_REPLICATION);
            RheniumChloride.addFlags(DISABLE_REPLICATION);
            AntimonyPentafluoride.addFlags(DISABLE_REPLICATION);
            AntimonyTrichloride.addFlags(DISABLE_REPLICATION);
            FluorophosphoricAcid.addFlags(DISABLE_REPLICATION);
            ChargedCaesiumCeriumCobaltIndium.addFlags(DISABLE_REPLICATION);
            VanadiumSlag.addFlags(DISABLE_REPLICATION);
            VanadiumSlagDust.addFlags(DISABLE_REPLICATION);
            VanadiumWasteSolution.addFlags(DISABLE_REPLICATION);
            PropargylAlcohol.addFlags(DISABLE_REPLICATION);
            PropargylChloride.addFlags(DISABLE_REPLICATION);
            Resin.addFlags(DISABLE_REPLICATION);
            Turpentine.addFlags(DISABLE_REPLICATION);
            BetaPinene.addFlags(DISABLE_REPLICATION);
            Citral.addFlags(DISABLE_REPLICATION);
            BetaIonone.addFlags(DISABLE_REPLICATION);
            VitaminA.addFlags(DISABLE_REPLICATION);
            Yeast.addFlags(DISABLE_REPLICATION);
            LinoleicAcid.addFlags(DISABLE_REPLICATION);
            Biotin.addFlags(DISABLE_REPLICATION);
            Catalase.addFlags(DISABLE_REPLICATION);
            B27Supplement.addFlags(DISABLE_REPLICATION);
            CleanAmmoniaSolution.addFlags(DISABLE_REPLICATION);
            Glutamine.addFlags(DISABLE_REPLICATION);
            Blood.addFlags(DISABLE_REPLICATION);
            BloodCells.addFlags(DISABLE_REPLICATION);
            BloodPlasma.addFlags(DISABLE_REPLICATION);
            BFGF.addFlags(DISABLE_REPLICATION);
            EGF.addFlags(DISABLE_REPLICATION);
            SilicaGelBase.addFlags(DISABLE_REPLICATION);
            SilicaAluminaGel.addFlags(DISABLE_REPLICATION);
            PiranhaSolution.addFlags(DISABLE_REPLICATION);
            ChlorosulfonicAcid.addFlags(DISABLE_REPLICATION);
            AcetylsulfanilylChloride.addFlags(DISABLE_REPLICATION);
            Sulfanilamide.addFlags(DISABLE_REPLICATION);
            AnimalCells.addFlags(DISABLE_REPLICATION);
            RapidlyReplicatingAnimalCells.addFlags(DISABLE_REPLICATION);
            Oct4Gene.addFlags(DISABLE_REPLICATION);
            SOX2Gene.addFlags(DISABLE_REPLICATION);
            KFL4Gene.addFlags(DISABLE_REPLICATION);
            GeneTherapyFluid.addFlags(DISABLE_REPLICATION);
            Cas9.addFlags(DISABLE_REPLICATION);
            MycGene.addFlags(DISABLE_REPLICATION);
            GenePlasmids.addFlags(DISABLE_REPLICATION);
            Chitin.addFlags(DISABLE_REPLICATION);
            ZincCokePellets.addFlags(DISABLE_REPLICATION);
            ZincResidualSlag.addFlags(DISABLE_REPLICATION);
            ZincExhaustMixture.addFlags(DISABLE_REPLICATION);
            ZincSulfate.addFlags(DISABLE_REPLICATION);
            ZincLeachingResidue.addFlags(DISABLE_REPLICATION);
            ZincFlueDust.addFlags(DISABLE_REPLICATION);
            FineZincSlagDust.addFlags(DISABLE_REPLICATION);
            ZincSlagSlurry.addFlags(DISABLE_REPLICATION);
            MetalRichSlagSlurry.addFlags(DISABLE_REPLICATION);
            AcidicMetalSlurry.addFlags(DISABLE_REPLICATION);
            SeparatedMetalSlurry.addFlags(DISABLE_REPLICATION);
            MetalHydroxideMix.addFlags(DISABLE_REPLICATION);
            ZincPoorMix.addFlags(DISABLE_REPLICATION);
            IronPoorMix.addFlags(DISABLE_REPLICATION);
            IndiumHydroxideConcentrate.addFlags(DISABLE_REPLICATION);
            IndiumHydroxide.addFlags(DISABLE_REPLICATION);
            CadmiumZincDust.addFlags(DISABLE_REPLICATION);
            CadmiumThalliumLiquor.addFlags(DISABLE_REPLICATION);
            ZincAmalgam.addFlags(DISABLE_REPLICATION);
            ThalliumResidue.addFlags(DISABLE_REPLICATION);
            CadmiumSulfateSolution.addFlags(DISABLE_REPLICATION);
            ThalliumSulfateSolution.addFlags(DISABLE_REPLICATION);
            ZincChloride.addFlags(DISABLE_REPLICATION);
            SodiumSulfite.addFlags(DISABLE_REPLICATION);
            PolyphenolMix.addFlags(DISABLE_REPLICATION);
            AcidifiedPolyphenolMix.addFlags(DISABLE_REPLICATION);
            Diethylether.addFlags(DISABLE_REPLICATION);
            TannicAcid.addFlags(DISABLE_REPLICATION);
            GermanicAcidSolution.addFlags(DISABLE_REPLICATION);
            GermaniumChloride.addFlags(DISABLE_REPLICATION);
            BariumHydroxide.addFlags(DISABLE_REPLICATION);
            ThiocyanicAcid.addFlags(DISABLE_REPLICATION);
            ZrHfSeparationMix.addFlags(DISABLE_REPLICATION);
            ZrHfChloride.addFlags(DISABLE_REPLICATION);
            ZirconChlorinatingResidue.addFlags(DISABLE_REPLICATION);
            SiliconChloride.addFlags(DISABLE_REPLICATION);
            ZrHfOxyChloride.addFlags(DISABLE_REPLICATION);
            HafniumOxide.addFlags(DISABLE_REPLICATION);
            HafniumChloride.addFlags(DISABLE_REPLICATION);
            HeliumCNO.addFlags(DISABLE_REPLICATION);
            Iron52.addFlags(DISABLE_REPLICATION);
            Chromium48.addFlags(DISABLE_REPLICATION);
            Titanium44.addFlags(DISABLE_REPLICATION);
            Nickel56.addFlags(DISABLE_REPLICATION);
            LiquidEnrichedHelium.addFlags(DISABLE_REPLICATION);
            AbyssalAlloy.addFlags(DISABLE_REPLICATION);
            CosmicNeutronium.addFlags(DISABLE_REPLICATION);
            HighEnergyQGP.addFlags(DISABLE_REPLICATION);
            CaliforniumCyclopentadienide.addFlags(DISABLE_REPLICATION);
            IridiumTrioxide.addFlags(DISABLE_REPLICATION);
            IridiumTrichlorideSolution.addFlags(DISABLE_REPLICATION);
            SemisolidHydrogen.addFlags(DISABLE_REPLICATION);
            MicrocrystallizingHydrogen.addFlags(DISABLE_REPLICATION);
            Vinteum.addFlags(DISABLE_REPLICATION);
            Tanzanite.addFlags(DISABLE_REPLICATION);
            Dibismusthydroborat.addFlags(DISABLE_REPLICATION);
            CircuitCompoundMK3.addFlags(DISABLE_REPLICATION);
            HyperFuelI.addFlags(DISABLE_REPLICATION);
            HyperFuelII.addFlags(DISABLE_REPLICATION);
            HyperFuelIII.addFlags(DISABLE_REPLICATION);
            HyperFuelIV.addFlags(DISABLE_REPLICATION);
            NaquadricSolution.addFlags(DISABLE_REPLICATION);
            EnrichedNaquadricSolution.addFlags(DISABLE_REPLICATION);
            NaquadriaticSolution.addFlags(DISABLE_REPLICATION);
            EnrichedFluoronaquadricAcid.addFlags(DISABLE_REPLICATION);
            FluoronaquadriaticAcid.addFlags(DISABLE_REPLICATION);
            NaquadahDifluoride.addFlags(DISABLE_REPLICATION);
            EnrichedNaquadahDifluoride.addFlags(DISABLE_REPLICATION);
            NaquadriaDifluoride.addFlags(DISABLE_REPLICATION);
            IndiumTrifluoride.addFlags(DISABLE_REPLICATION);
            NaquadahConcentrate.addFlags(DISABLE_REPLICATION);
            EnrichedNaquadahConcentrate.addFlags(DISABLE_REPLICATION);
            NaquadriaConcentrate.addFlags(DISABLE_REPLICATION);
            NaquadriaHexafluoride.addFlags(DISABLE_REPLICATION);
            RadonDifluoride.addFlags(DISABLE_REPLICATION);
            RadonNaquadriaoctafluoride.addFlags(DISABLE_REPLICATION);
            CesiumFluoride.addFlags(DISABLE_REPLICATION);
            CesiumXenontrioxideFluoride.addFlags(DISABLE_REPLICATION);
            NaquadriaCesiumXenonNonfluoride.addFlags(DISABLE_REPLICATION);
            NitrylFluoride.addFlags(DISABLE_REPLICATION);
            NitrosoniumOctafluoroxenate.addFlags(DISABLE_REPLICATION);
            NaquadriaCesiumfluoride.addFlags(DISABLE_REPLICATION);
            EnrichedNaquadahhexafluoride.addFlags(DISABLE_REPLICATION);
            EnrichedXenonHexafluoronaquadate.addFlags(DISABLE_REPLICATION);
            BromineTrifluoride.addFlags(DISABLE_REPLICATION);
            AuricFluoride.addFlags(DISABLE_REPLICATION);
            XenoauricFluoroantimonicAcid.addFlags(DISABLE_REPLICATION);
            NaquadahSulfate.addFlags(DISABLE_REPLICATION);
            IndiumTrioxide.addFlags(DISABLE_REPLICATION);
            NaquadahSolution.addFlags(DISABLE_REPLICATION);
            ClearNaquadahLiquid.addFlags(DISABLE_REPLICATION);
            ComplicatedNaquadahGas.addFlags(DISABLE_REPLICATION);
            ComplicatedLightNaquadah.addFlags(DISABLE_REPLICATION);
            ComplicatedMediumNaquadah.addFlags(DISABLE_REPLICATION);
            ComplicatedHeavyNaquadah.addFlags(DISABLE_REPLICATION);
            NaquadahGas.addFlags(DISABLE_REPLICATION);
            HeavyNaquadah.addFlags(DISABLE_REPLICATION);
            LightNaquadah.addFlags(DISABLE_REPLICATION);
            MediumNaquadah.addFlags(DISABLE_REPLICATION);
            FCrackedMediumNaquadah.addFlags(DISABLE_REPLICATION);
            FCrackedLightNaquadah.addFlags(DISABLE_REPLICATION);
            FCrackedHeavyNaquadah.addFlags(DISABLE_REPLICATION);
            LightNaquadahFuel.addFlags(DISABLE_REPLICATION);
            MediumNaquadahFuel.addFlags(DISABLE_REPLICATION);
            HeavyNaquadahFuel.addFlags(DISABLE_REPLICATION);
            ENaquadahSolution.addFlags(DISABLE_REPLICATION);
            ClearENaquadahLiquid.addFlags(DISABLE_REPLICATION);
            ComplicatedLightENaquadah.addFlags(DISABLE_REPLICATION);
            ComplicatedMediumENaquadah.addFlags(DISABLE_REPLICATION);
            ComplicatedHeavyENaquadah.addFlags(DISABLE_REPLICATION);
            HeavyENaquadah.addFlags(DISABLE_REPLICATION);
            MediumENaquadah.addFlags(DISABLE_REPLICATION);
            LightENaquadah.addFlags(DISABLE_REPLICATION);
            RnCrackedMediumENaquadah.addFlags(DISABLE_REPLICATION);
            RnCrackedLightNaquadah.addFlags(DISABLE_REPLICATION);
            RnCrackedHeavyENaquadah.addFlags(DISABLE_REPLICATION);
            LightENaquadahFuel.addFlags(DISABLE_REPLICATION);
            MediumENaquadahFuel.addFlags(DISABLE_REPLICATION);
            HeavyENaquadahFuel.addFlags(DISABLE_REPLICATION);
            FluoronaquadricAcid.addFlags(DISABLE_REPLICATION);
            Fluorescein.addFlags(DISABLE_REPLICATION);
            BoronTrifluorideEtherate.addFlags(DISABLE_REPLICATION);
            Decaborane.addFlags(DISABLE_REPLICATION);
            SodiumTetrafluoroborate.addFlags(DISABLE_REPLICATION);
            CesiumCarboranePrecusor.addFlags(DISABLE_REPLICATION);
            BoraneDimethylsulfide.addFlags(DISABLE_REPLICATION);
            CesiumCarborane.addFlags(DISABLE_REPLICATION);
            SilverNitrate.addFlags(DISABLE_REPLICATION);
            Fluorocarborane.addFlags(DISABLE_REPLICATION);
            CaesiumNitrate.addFlags(DISABLE_REPLICATION);
            SilverIodide.addFlags(DISABLE_REPLICATION);
            FumingNitricAcid.addFlags(DISABLE_REPLICATION);
            PureCrystallineNitricAcid.addFlags(DISABLE_REPLICATION);
            ActiniumTriniumHydroxides.addFlags(DISABLE_REPLICATION);
            ResidualTriniiteSolution.addFlags(DISABLE_REPLICATION);
            Perfluorobenzene.addFlags(DISABLE_REPLICATION);
            ActiniumRadiumHydroxideSolution.addFlags(DISABLE_REPLICATION);
            HeavilyFluorinatedTriniumSolution.addFlags(DISABLE_REPLICATION);
            MoltenCalciumSalts.addFlags(DISABLE_REPLICATION);
            TriniumTetrafluoride.addFlags(DISABLE_REPLICATION);
            AcetylChloride.addFlags(DISABLE_REPLICATION);
            EthylTrifluoroacetate.addFlags(DISABLE_REPLICATION);
            PhosphorousPentasulfide.addFlags(DISABLE_REPLICATION);
            Acetothienone.addFlags(DISABLE_REPLICATION);
            TheonylTrifluoroacetate.addFlags(DISABLE_REPLICATION);
            ActiniumRadiumNitrateSolution.addFlags(DISABLE_REPLICATION);
            ActiniumNitrate.addFlags(DISABLE_REPLICATION);
            RadiumNitrate.addFlags(DISABLE_REPLICATION);
            LithiumPeroxideSolution.addFlags(DISABLE_REPLICATION);
            NitrogenPentoxide.addFlags(DISABLE_REPLICATION);
            TitaniumNitrate.addFlags(DISABLE_REPLICATION);
            Carbon12.addFlags(DISABLE_REPLICATION);
            Carbon13.addFlags(DISABLE_REPLICATION);
            Nitrogen14.addFlags(DISABLE_REPLICATION);
            NItrogen15.addFlags(DISABLE_REPLICATION);
            CNOcatalyst.addFlags(DISABLE_REPLICATION);
            QuassifissioningPlasma.addFlags(DISABLE_REPLICATION, DISABLE_DECONSTRUCTION);
            FlYbPlasma.addFlags(DISABLE_REPLICATION, DISABLE_DECONSTRUCTION);
            Ytterbium178.addFlags(DISABLE_REPLICATION);
            TitaniumTetrafluoride.addFlags(DISABLE_REPLICATION);
            Titanium50Tetrafluoride.addFlags(DISABLE_REPLICATION);
            OgannesonBreedingBase.addFlags(DISABLE_REPLICATION);
            HotMetastableOganesson.addFlags(DISABLE_REPLICATION);
            HafniumCarbide.addFlags(DISABLE_REPLICATION);
            SeaborgiumCarbide.addFlags(DISABLE_REPLICATION);
            Calcium44.addFlags(DISABLE_REPLICATION);
            Helium4.addFlags(DISABLE_REPLICATION);
            PalladiumAmmonia.addFlags(DISABLE_REPLICATION);
            PlatinumConcentrate.addFlags(DISABLE_REPLICATION);
            RhodiumSulfateSolution.addFlags(DISABLE_REPLICATION);
            RhodiumSaltSolution.addFlags(DISABLE_REPLICATION);
            AcidicIridiumSolution.addFlags(DISABLE_REPLICATION);
            RhodiumFilterCakeSolution.addFlags(DISABLE_REPLICATION);
            RutheniumTetroxideSolution.addFlags(DISABLE_REPLICATION);
            HotRutheniumTetroxideSolution.addFlags(DISABLE_REPLICATION);
            OsmiumSolution.addFlags(DISABLE_REPLICATION);
            LithiumHydroxide.addFlags(DISABLE_REPLICATION);
            TungstenHexachloride.addFlags(DISABLE_REPLICATION);
            Bowieite.addFlags(DISABLE_REPLICATION);
            PlatinumMetallicPowder.addFlags(DISABLE_REPLICATION);
            CrudeRhodiumMetal.addFlags(DISABLE_REPLICATION);
            PGSDResidue2.addFlags(DISABLE_REPLICATION);
            PlatinumResidue.addFlags(DISABLE_REPLICATION);
            PotassiumDisulfate.addFlags(DISABLE_REPLICATION);
            LeachResidue.addFlags(DISABLE_REPLICATION);
            PalladiumSalt.addFlags(DISABLE_REPLICATION);
            PalladiumRawPowder.addFlags(DISABLE_REPLICATION);
            RhodiumFilterCake.addFlags(DISABLE_REPLICATION);
            RhodiumSalt.addFlags(DISABLE_REPLICATION);
            PalladiumMetallicPowder.addFlags(DISABLE_REPLICATION);
            MicaPulp.addFlags(DISABLE_REPLICATION, DISABLE_DECONSTRUCTION);
            NickelOxideHydroxide.addFlags(DISABLE_REPLICATION);
            LithiumCobaltOxide.addFlags(DISABLE_REPLICATION);
            LithiumTriflate.addFlags(DISABLE_REPLICATION);
            Xylose.addFlags(DISABLE_REPLICATION);
            SodiumAlginateSolution.addFlags(DISABLE_REPLICATION);
            CalciumAlginate.addFlags(DISABLE_REPLICATION);
            SiliconNanoparticles.addFlags(DISABLE_REPLICATION);
            Sorbose.addFlags(DISABLE_REPLICATION);
            AscorbicAcid.addFlags(DISABLE_REPLICATION);
            DehydroascorbicAcid.addFlags(DISABLE_REPLICATION);
            GalliumChloride.addFlags(DISABLE_REPLICATION);
            Halloysite.addFlags(DISABLE_REPLICATION);
            SulfurCoatedHalloysite.addFlags(DISABLE_REPLICATION);
            FluorideBatteryElectrolyte.addFlags(DISABLE_REPLICATION);
            LanthanumNickelOxide.addFlags(DISABLE_REPLICATION);
            HG1223.addFlags(DISABLE_REPLICATION);
            Indalloy140.addFlags(DISABLE_REPLICATION);
            Seabohrgium.addFlags(DISABLE_REPLICATION);
            Fordnium.addFlags(DISABLE_REPLICATION);
            Enargite.addFlags(DISABLE_REPLICATION);
            Dolomite.addFlags(DISABLE_REPLICATION);
            Wollastonite.addFlags(DISABLE_REPLICATION);
            Kaolinite.addFlags(DISABLE_REPLICATION);
            Tenorite.addFlags(DISABLE_REPLICATION);
            Tennantite.addFlags(DISABLE_REPLICATION);
            Cuprite.addFlags(DISABLE_REPLICATION);
            Zirkelite.addFlags(DISABLE_REPLICATION);
            Arsenopyrite.addFlags(DISABLE_REPLICATION);
            BrightSteel.addFlags(DISABLE_REPLICATION);
            Gallite.addFlags(DISABLE_REPLICATION);
            BabbittAlloy.addFlags(DISABLE_REPLICATION);
            Inconel625.addFlags(DISABLE_REPLICATION);
            ApatiteAcidicLeach.addFlags(DISABLE_REPLICATION);
            PhosphorousArsenicSolution.addFlags(DISABLE_REPLICATION);
            ApatiteSolidResidue.addFlags(DISABLE_REPLICATION);
            FluoroApatite.addFlags(DISABLE_REPLICATION);
            FluoroapatiteAcidicLeach.addFlags(DISABLE_REPLICATION);
            FluoroapatiteSolidResidue.addFlags(DISABLE_REPLICATION);
            SodiumArsenate.addFlags(DISABLE_REPLICATION);
            FinelyPowderedRutile.addFlags(DISABLE_REPLICATION);
            RawSienna.addFlags(DISABLE_REPLICATION);
            BurnedSienna.addFlags(DISABLE_REPLICATION);
            MercuryNitrate.addFlags(DISABLE_REPLICATION);
            MercuryChloride.addFlags(DISABLE_REPLICATION);
            MercuryIodide.addFlags(DISABLE_REPLICATION);
            BismuthVanadateSolution.addFlags(DISABLE_REPLICATION);
            BismuthVanadate.addFlags(DISABLE_REPLICATION);
            CopperArsenite.addFlags(DISABLE_REPLICATION);
            ScheelesGreen.addFlags(DISABLE_REPLICATION);
            CobaltZincOxide.addFlags(DISABLE_REPLICATION);
            CobaltAluminate.addFlags(DISABLE_REPLICATION);
            PotassiumFerrocyanide.addFlags(DISABLE_REPLICATION);
            PrussianBlue.addFlags(DISABLE_REPLICATION);
            TitaniumYellow.addFlags(DISABLE_REPLICATION);
            ManganeseIIIOxide.addFlags(DISABLE_REPLICATION);
            AmmoniumManganesePhosphate.addFlags(DISABLE_REPLICATION);
            HanPurple.addFlags(DISABLE_REPLICATION);
            ChromeYellow.addFlags(DISABLE_REPLICATION);
            ChromeOrange.addFlags(DISABLE_REPLICATION);
            Nitrotoluene.addFlags(DISABLE_REPLICATION);
            DiaminostilbenedisulfonicAcid.addFlags(DISABLE_REPLICATION);
            Nigrosin.addFlags(DISABLE_REPLICATION);
            SodiumSulfanilate.addFlags(DISABLE_REPLICATION);
            Naphthylamine.addFlags(DISABLE_REPLICATION);
            DirectBrown.addFlags(DISABLE_REPLICATION);
            DianilineterephthalicAcid.addFlags(DISABLE_REPLICATION);
            Quinacridone.addFlags(DISABLE_REPLICATION);
            Acetoacetanilide.addFlags(DISABLE_REPLICATION);
            DiarylideYellow.addFlags(DISABLE_REPLICATION);
            Quinizarin.addFlags(DISABLE_REPLICATION);
            Toluidine.addFlags(DISABLE_REPLICATION);
            AlizarineCyanineGreen.addFlags(DISABLE_REPLICATION);
            Anthraquinone.addFlags(DISABLE_REPLICATION);
            Aminoanthraquinone.addFlags(DISABLE_REPLICATION);
            IndanthroneBlue.addFlags(DISABLE_REPLICATION);
            Mauveine.addFlags(DISABLE_REPLICATION);
            Isopropylsuccinate.addFlags(DISABLE_REPLICATION);
            Benzonitrile.addFlags(DISABLE_REPLICATION);
            Diketopyrrolopyrrole.addFlags(DISABLE_REPLICATION);
            Indigo.addFlags(DISABLE_REPLICATION);
            Tetrabromoindigo.addFlags(DISABLE_REPLICATION);
            CyanIndigoDye.addFlags(DISABLE_REPLICATION);
            Erythrosine.addFlags(DISABLE_REPLICATION);
            DeepOverworldGas.addFlags(DISABLE_REPLICATION);
            DeepNetherGas.addFlags(DISABLE_REPLICATION);
        }
    }
    ...
    private static void registerSuperconductors() {
        ...
        if (GCYLCore.isModLoaded("materialreplication")) {
            ...
            EVSuperconductorBase.addFlags(DISABLE_REPLICATION);
            IVSuperconductorBase.addFlags(DISABLE_REPLICATION);
            LuVSuperconductorBase.addFlags(DISABLE_REPLICATION);
            ZPMSuperconductorBase.addFlags(DISABLE_REPLICATION);
            UVSuperconductorBase.addFlags(DISABLE_REPLICATION);
            UHVSuperconductorBase.addFlags(DISABLE_REPLICATION);
            UEVSuperconductorBase.addFlags(DISABLE_REPLICATION);
            UIVSuperconductorBase.addFlags(DISABLE_REPLICATION);
            UXVSuperconductorBase.addFlags(DISABLE_REPLICATION);
            OpVSuperconductorBase.addFlags(DISABLE_REPLICATION);
            LVSuperconductor.addFlags(DISABLE_REPLICATION);
            MVSuperconductor.addFlags(DISABLE_REPLICATION);
            HVSuperconductor.addFlags(DISABLE_REPLICATION);
            EVSuperconductor.addFlags(DISABLE_REPLICATION);
            IVSuperconductor.addFlags(DISABLE_REPLICATION);
            LuVSuperconductor.addFlags(DISABLE_REPLICATION);
            ZPMSuperconductor.addFlags(DISABLE_REPLICATION);
            UVSuperconductor.addFlags(DISABLE_REPLICATION);
            UHVSuperconductor.addFlags(DISABLE_REPLICATION);
            UEVSuperconductor.addFlags(DISABLE_REPLICATION);
            UIVSuperconductor.addFlags(DISABLE_REPLICATION);
            UXVSuperconductor.addFlags(DISABLE_REPLICATION);
            OpVSuperconductor.addFlags(DISABLE_REPLICATION);
            MAXSuperconductor.addFlags(DISABLE_REPLICATION);
        }
    }
    ...
    private static void initDEMaterials() {
        ...
        Chaos = new Material.Builder(++id, gcylId("chaos"))
                ...
                .iconSet(DULL)
                .flags(GENERATE_PLATE,  GENERATE_DENSE, GENERATE_ROD, GENERATE_FRAME, GENERATE_FINE_WIRE, GENERATE_BOLT_SCREW)
                .blast(25000)
                .build()
        ...
        ChaosAlloy = new Material.Builder(++id, gcylId("chaosalloy"))
                ...
                .iconSet(SHINY)
                .flags(GENERATE_PLATE,  GENERATE_DENSE, GENERATE_FINE_WIRE, GENERATE_BOLT_SCREW)
                .blast(50000)
                .build()
        ...
        if (GCYLCore.isModLoaded("materialreplication")) {
            ...
            ChaosAlloy.addFlags(DISABLE_REPLICATION, DISABLE_DECONSTRUCTION);
        }
    }
    ...
    private static void register3() {
        ...
        DuctileA356 = new Material.Builder(++id, gcylId("ductile_a_356"))
                ...
                .flags(NO_SMELTING, GENERATE_FINE_WIRE)
        ...
        if (GCYLCore.isModLoaded("materialreplication")) {
            ...
            HotHPHelium3.addFlags(DISABLE_REPLICATION);
            HotHPHelium4.addFlags(DISABLE_REPLICATION);
            HotLiquidSodium.addFlags(DISABLE_REPLICATION);
            HotMercury.addFlags(DISABLE_REPLICATION);
            HotLiquidTin.addFlags(DISABLE_REPLICATION);
            HotLiquidLead.addFlags(DISABLE_REPLICATION);
        }
    }
