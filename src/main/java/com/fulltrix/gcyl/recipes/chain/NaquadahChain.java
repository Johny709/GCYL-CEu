...
public class NaquadahChain {
    ...
    public static void init() {
        ...
        BLAST_RECIPES.recipeBuilder()
                ...
                .input(dust, Indium, 2)
                .output(dust,IndiumTrifluoride,8)
                .output(dust,EnrichedNaquadahConcentrate,3)
                .EUt(30720)
                .duration(100)
                .blastFurnaceTemp(4500)
                .buildAndRegister();
        ...
        BLAST_RECIPES.recipeBuilder()
                ...
                .input(dust, Indium, 2)
                .output(dust,IndiumTrifluoride,8)
                .output(dust,NaquadriaConcentrate,3)
                .EUt(30720)
                .duration(100)
                .blastFurnaceTemp(4500)
                .buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .input(dust,NaquadriaConcentrate,1)
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                .input(dust,EnrichedNaquadahConcentrate,1)
                .fluidInputs(Fluorine.getFluid(6000))
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .output(dust,PotassiumPeroxymonosulfate,16)
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .output(dust,PotassiumPeroxymonosulfate,8)
                .EUt(480)
                .duration(100)
                .buildAndRegister();
        ...
        CHEMICAL_RECIPES.recipeBuilder()
                ...
                .input(dust,NaquadahConcentrate,1)
                .fluidOutputs(Water.getFluid(1000))
        ...
        CENTRIFUGE_RECIPES.recipeBuilder()
                ...
                .output(dustTiny, PlatinumRaw, 15)
